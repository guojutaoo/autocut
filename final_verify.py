#!/usr/bin/env python3
"""
Final verification of subtitle position fix.
Generates test videos and analyzes subtitle positions.
"""
...
TEST_DURATION = 3
BOTTOM_MARGIN = 120
OUTPUT_DIR = "/Users/bytedance/Downloads/autocut/final_verify_output"
...
def create_test_ass(text, num_lines, output_path):
    ...
    line_height = 62
    target_first_line_y = VIDEO_HEIGHT - BOTTOM_MARGIN  # 1800
    base_offset = 14
...
def analyze_frame(frame_path, num_lines):
...
def main():
    ...
    print("=" * 70)
    print("最终验证：字幕第一行位置是否固定")
    print("=" * 70)
    print(f"\n视频高度: {VIDEO_HEIGHT}px")
    print(f"目标底部边距: {BOTTOM_MARGIN}px")
    ...
    for text, num_lines, name in test_cases:
        ...
        # Analyze
        actual_y = analyze_frame(frame_path, num_lines)
